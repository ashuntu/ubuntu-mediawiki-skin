jest.mock( '../../resources/skins.ubuntu.js/features.js' );
jest.mock( '../../resources/skins.ubuntu.js/popupNotification.js' );

const features = require( '../../resources/skins.ubuntu.js/features.js' );
const popupNotification = require( '../../resources/skins.ubuntu.js/popupNotification.js' );
const mustache = require( 'mustache' );
const fs = require( 'fs' );
const pinnableHeaderTemplate = fs.readFileSync( 'includes/templates/PinnableHeader.mustache', 'utf8' );
const pinnableElement = require( '../../resources/skins.ubuntu.js/pinnableElement.js' );
